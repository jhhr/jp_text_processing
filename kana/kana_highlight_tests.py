...
{RESET}"""
    ...
    test(
        test_name="Long vowel mark ー after an え-row kana matches an えい onyomi",
        kanji="生",
        onyomi_to_katakana=False,
        sentence="先生[せんせー]",
        expected_furigana=" 先[せん]<b> 生[せー]</b>",
        expected_furigana_with_tags_split="<on> 先[せん]</on><b><on> 生[せー]</on></b>",
        expected_furigana_with_tags_merged="<on> 先[せん]</on><b><on> 生[せー]</on></b>",
        expected_furikanji=" せん[先]<b> せー[生]</b>",
        expected_furikanji_with_tags_split="<on> せん[先]</on><b><on> せー[生]</on></b>",
        expected_furikanji_with_tags_merged="<on> せん[先]</on><b><on> せー[生]</on></b>",
        expected_kana_only="せん<b>せー</b>",
        expected_kana_only_with_tags_split="<on>せん</on><b><on>せー</on></b>",
        expected_kana_only_with_tags_merged="<on>せん</on><b><on>せー</on></b>",
    )
    test(
        test_name="Long vowel mark ー after け matches a けい onyomi",
        kanji="",
        sentence="計画[けーかく]",
        expected_furigana=" 計画[ケーカク]",
        expected_furigana_with_tags_split="<on> 計[ケー]</on><on> 画[カク]</on>",
        expected_furigana_with_tags_merged="<on> 計画[ケーカク]</on>",
        expected_furikanji=" ケーカク[計画]",
        expected_furikanji_with_tags_split="<on> ケー[計]</on><on> カク[画]</on>",
        expected_furikanji_with_tags_merged="<on> ケーカク[計画]</on>",
        expected_kana_only="ケーカク",
        expected_kana_only_with_tags_split="<on>ケー</on><on>カク</on>",
        expected_kana_only_with_tags_merged="<on>ケーカク</on>",
    )
    test(
        test_name="Long vowel mark ー after an あ-row kana matches an ああ kunyomi",
        kanji="婆",
        sentence="お婆[ばー]ちゃん",
        expected_furigana="お<b> 婆[ばー]</b>ちゃん",
        expected_furigana_with_tags_split="お<b><kun> 婆[ばー]</kun></b>ちゃん",
        expected_furigana_with_tags_merged="お<b><kun> 婆[ばー]</kun></b>ちゃん",
        expected_furikanji="お<b> ばー[婆]</b>ちゃん",
        expected_furikanji_with_tags_split="お<b><kun> ばー[婆]</kun></b>ちゃん",
        expected_furikanji_with_tags_merged="お<b><kun> ばー[婆]</kun></b>ちゃん",
        expected_kana_only="お<b>ばー</b>ちゃん",
        expected_kana_only_with_tags_split="お<b><kun>ばー</kun></b>ちゃん",
        expected_kana_only_with_tags_merged="お<b><kun>ばー</kun></b>ちゃん",
    )
    test(
        test_name="Long vowel mark ー after a small ょ lengthens the palatalized mora",
        kanji="",
        sentence="東京[とーきょー]",
        expected_furigana=" 東京[トーキョー]",
        expected_furigana_with_tags_split="<on> 東[トー]</on><on> 京[キョー]</on>",
        expected_furigana_with_tags_merged="<on> 東京[トーキョー]</on>",
        expected_furikanji=" トーキョー[東京]",
        expected_furikanji_with_tags_split="<on> トー[東]</on><on> キョー[京]</on>",
        expected_furikanji_with_tags_merged="<on> トーキョー[東京]</on>",
        expected_kana_only="トーキョー",
        expected_kana_only_with_tags_split="<on>トー</on><on>キョー</on>",
        expected_kana_only_with_tags_merged="<on>トーキョー</on>",
    )
    test(
